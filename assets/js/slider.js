...
;(function(factory){
  ...
  /*
	 * We define the slider as a variable of type ‘function’. 
  ...
  var slider = (function(element, settings){
    ...
    /*
     * The constructor function for the slider
     *
     */
    function _slider(element, settings){
      ...
      // This property will be incremented everytime a new slider carousel is created
  ...
  /**
   ...
   slider.prototype.init = function(){
    ...
    this.$el.addClass('slider-carousel');
